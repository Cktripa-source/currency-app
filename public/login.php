...
<main class="container mx-auto p-4 my-40 md:my-2">
    ...
    <?php if (isset($error)): ?>
        <div class="bg-red-600 text-white p-4 rounded mb-4 p-2 border">
            <p><?php echo $error; ?></p>
        </div>
    <?php endif; ?>
    ...
    <form action="" method="POST" class="space-y-4 bg-white p-6 rounded shadow-md">
        ...
        <div>
            ...
            <input type="email" name="email" id="email" class="w-full border-gray-300 rounded-md p-2 border" required>
        </div>

        <!-- Password -->
        <div>
            <label for="password" class="block text-sm font-medium text-gray-700">Password</label>
            <input type="password" name="password" id="password" class="w-full border-gray-300 rounded-md p-2 border" required>
        </div>
