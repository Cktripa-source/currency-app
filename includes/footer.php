    ...
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between">
            ...
            <div class="mb-6 md:mb-0">
                <a href="#" class="flex items-center">
                    <img src="../public/asset/app-icon.png" class="h-8 me-3" alt="App Logo" />
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            ...
            <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">
                © 2023 <a href="#" class="hover:underline">Currency Exchange™</a>. All Rights Reserved.
            </span>
            <!-- Social Media Icons -->
            <div class="flex mt-4 sm:justify-center sm:mt-0">
                ...
                <a href="#" class="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5" aria-label="Twitter">
...
=======
<?php
// You can include this footer file on any page where you need the footer section
?>
    <!-- Footer Section -->
    <footer class="bg-blue-600 text-white p-10 h-60 w-full">
        <div class="max-w-7xl mx-auto flex justify-between items-center">
            <!-- Copyright Section -->
            <p class="text-sm">&copy; <?php echo date("Y"); ?> Currency Exchange App. All rights reserved.</p>
    ...
    <!-- Optional: Scripts -->
    <!-- You can add any JavaScript here if needed (e.g., for form validation, modals, etc.) -->
